""" Building on https://github.com/vinbigdata-medical/vindr-mammo/blob/master/visualize.py """
...
def load_image(dicom_file: str) -> np.ndarray:
    """
    ...
    a[mask_pad] = 0
    a = Image.fromarray(a.astype('uint8'), 'L')
    return a
